...
const Products = () => {
  ...
  return (
    <div className="mx-auto pb-5 w-full">
      ...
      {/* BODY PRODUCTS LIST */}
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-10 transition-all duration-500">
        {isLoading ? (
          <div>Loading...</div>
        ) : (
          products?.map((product) => (
            <div
              ...
              className=" shadow rounded-lg p-4 border border-gray-500/15"
            >
